...
VALUES
    ...
    (true, false, 'cshr-super-admin@domain.com', 'c4cb1208-eca7-46a6-b496-0f6f354c6eac', '$2a$10$eEvWOZ/wXNwL11SaQNV2q.CjE3AoIaRCle2984yYEB8Ul7UbreZNC');
...
VALUES
    ...
    ((SELECT id FROM identity WHERE email = 'cshr-super-admin@domain.com'), (SELECT id FROM role WHERE name = 'LEARNER')),
    ((SELECT id FROM identity WHERE email = 'cshr-super-admin@domain.com'), (SELECT id FROM role WHERE name = 'LEARNING_MANAGER')),
    ((SELECT id FROM identity WHERE email = 'cshr-super-admin@domain.com'), (SELECT id FROM role WHERE name = 'IDENTITY_MANAGER')),
    ((SELECT id FROM identity WHERE email = 'cshr-super-admin@domain.com'), (SELECT id FROM role WHERE name = 'ORGANISATION_MANAGER')),
    ((SELECT id FROM identity WHERE email = 'cshr-super-admin@domain.com'), (SELECT id FROM role WHERE name = 'DOWNLOAD_BOOKING_FEED')),
    ((SELECT id FROM identity WHERE email = 'cshr-super-admin@domain.com'), (SELECT id FROM role WHERE name = 'CSHR_REPORTER'));
