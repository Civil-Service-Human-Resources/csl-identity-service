...
public class ResetControllerTest {
    ...
    public void shouldLoadCheckEmailPageIfIdentityExistsForTheGivenEmailId() throws Exception {
        ...
        mockMvc.perform(post("/reset")
                ...
                .andExpect(content().string(containsString("If <span>" + EMAIL + "</span> belongs to a valid account you will receive an email with a reset link.")))
                .andExpect(content().string(containsString("Please check any spam or junk mail folders if you don’t see the email.")))
