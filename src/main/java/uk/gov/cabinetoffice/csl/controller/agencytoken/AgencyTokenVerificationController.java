    ...
    public String checkToken(Model model,
        ...
        try {
            ...
            if (!agencyTokenCapacityService.hasSpaceAvailable(agencyToken)) {
                log.error("Agency token uid = {}, capacity = {}, has no spaces available. User {} unable to signup",
            ...
            log.error("ResourceNotFoundException during agency verification for form: {}", form);
            ...
            log.error("NotEnoughSpaceAvailableException during agency verification for form: {}", form);
