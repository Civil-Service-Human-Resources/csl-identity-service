...
public class ApplicationConstants {
    ...
    public static final String CHANGE_EMAIL_ERROR_MESSAGE = "There is a problem with changing your email, please try again later.";

    public static final String VERIFY_AGENCY_TOKEN_ERROR_MESSAGE = "There is a problem with this agency token, please try again later.";

    public static final String SIGNUP_RESOURCE_NOT_FOUND_ERROR_MESSAGE = "Cannot complete signup as there is a problem with the token provided. Please contact your line manager.";
    ...
    public static final String ACCOUNT_REACTIVATION_ERROR_MESSAGE = "There is an error processing account reactivation. Please try again later.";
