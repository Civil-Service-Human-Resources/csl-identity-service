...
public class ApplicationConstants {
    ...
    public static final String NO_SPACES_AVAILABLE_ERROR_MESSAGE =
            "No spaces available for this token. Please contact your line manager";

    public static final String CHANGE_EMAIL_ERROR_MESSAGE =
    ...
    public static final String SIGNUP_NO_SPACES_AVAILABLE_ERROR_MESSAGE =
            "Cannot complete signup as there are no spaces available for this token. Please contact your line manager";

    public static final String ACCOUNT_REACTIVATION_ERROR_MESSAGE =
            "There was an error processing account reactivation. Please try again";
